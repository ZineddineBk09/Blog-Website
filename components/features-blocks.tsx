export default function FeaturesBlocks() {
  return (
    <section className="relative">
      ...
      <div
        className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-green-500 pointer-events-none"
        aria-hidden="true"
      ></div>
      <div className="absolute left-0 right-0 bottom-0 m-auto w-px p-px h-20 bg-green-200 transform translate-y-1/2"></div>
